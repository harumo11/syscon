...
PidController::PidController(const double dt, const double kp, const double ki, const double kd) {
    this->setDt(dt);
    this->setKp(kp);
    this->setKi(kd);
    this->setKd(kd);
...
std::string PidController::getExceptionMessageAboutGainInit(const std::string parameter_name, const double gain_value)
{
